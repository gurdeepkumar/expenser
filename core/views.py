...
def home(request):
    if not request.user.is_authenticated:
        return render(request, "core/home.html", {"user_auth": False})

    else:
        current_url_name = resolve(
            request.path_info
        ).url_name  # Get the current URL name
        ...
        context = {
            ...
            "expenses": expenses,
            "show_welcome": current_url_name
            == "home",  # Show welcome text only on home
